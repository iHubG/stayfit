  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50">
      ...
      >
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto mb-8">
            Chat with AI to get personalized workouts. Track your progress. Stay
            consistent. Simple fitness made smarter.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button
              size="lg"
              className="bg-gradient-to-r from-blue-500 to-purple-500 hover:from-blue-600 hover:to-purple-600 text-white shadow-lg group"
              asChild
            >
              <Link to="/register">
                Start Your Journey
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <Card className="border-0 shadow-lg bg-gradient-to-br from-blue-50 to-blue-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="flex flex-col items-center text-center p-8">
                ...
                <p className="text-gray-600">
                  Just ask: "Give me a 30-minute home workout" and get instant
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-purple-50 to-purple-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="flex flex-col items-center text-center p-8">
                ...
                <p className="text-gray-600">
                  Get clear, easy-to-follow workout plans that fit your schedule
                  and fitness level
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-0 shadow-lg bg-gradient-to-br from-pink-50 to-pink-100 hover:shadow-xl transition-all duration-300 hover:-translate-y-1">
              <CardContent className="flex flex-col items-center text-center p-8">
                ...
                <p className="text-gray-600">
                  Mark workouts as complete and watch your consistency streak
                  grow day by day
                </p>
              </CardContent>
            </Card>
          ...
          <div className="grid gap-8 md:grid-cols-3">
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Tell us your fitness goals and preferences
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Chat to get personalized workout plans
              </p>
            </div>
            ...
            <div className="flex flex-col items-center">
              ...
              <p className="text-gray-600 text-sm">
                Complete workouts and track your progress
              </p>
            </div>
          </div>
        </div>
      ...
      <motion.section
        ...
        className="py-20 px-6 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500"
      >
        <div className="text-center max-w-3xl mx-auto">
          ...
          <Button
            size="lg"
            className="bg-white text-purple-600 hover:bg-gray-50 shadow-lg font-semibold"
            asChild
          >
